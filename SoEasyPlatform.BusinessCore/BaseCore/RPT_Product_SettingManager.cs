...
public class RPT_Product_SettingManager : DbContext<RPT_Product_Setting>
{
    ...
    public void Study()
    {
	   ...
	   /*********查询*********/
        ...
        conModels.Add(new ConditionalModel() { FieldName = typeof(RPT_Product_Setting).GetProperties()[0].Name, ConditionalType = ConditionalType.Equal, FieldValue = "1" });//id=1
        ...
        /*********插入*********/
        var insertData = new RPT_Product_Setting() { };//测试参数
		...
		/*********更新*********/
	    var updateData = new RPT_Product_Setting() {  };//测试参数
		...
		/*********删除*********/
	    var deldata = new RPT_Product_Setting() {  };//测试参数
